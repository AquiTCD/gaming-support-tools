  ...
  return (
    <>
      <div className="flex">
        ...
        <input type="url" id="currentUrl" value={fullUrl()} readOnly={true} className="text-left font-mono rounded-none rounded-r-lg bg-gray-50 border text-gray-900 block flex-1 min-w-0 w-full border-gray-300 px-1 py-0 md:px-3 md:py-1" />
        <button onClick={() => copyToClipboard()} type="button" className="ml-2 text-xs md:text-sm block border border-gray-300 text-gray-700 hover:text-gray-50 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg px-1 py-0 md:px-3 md:py-1 text-center inline-flex items-center">
        ...
        <a href={twitterUrl()} target="_blank" className="text-xs md:text-sm text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 ml-2 block rounded-lg px-1 py-0 md:px-3 md:py-1 text-center inline-flex items-center">
