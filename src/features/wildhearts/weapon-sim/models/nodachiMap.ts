export const nodachiCoordinates = [
                       '1D',                              '1I',                              '1N',
...
export type NodachiCoordinate = typeof nodachiCoordinates[number]
export type NodachiPath = [NodachiCoordinate, NodachiCoordinate]
export const nodachiPaths: NodachiPath[] = [
  ['1D', '4A'],
  ['1D', '4C'],
  ['1D', '6D'],
  ['1D', '4E'],
