...
export type Coordinate = KatanaCoordinate | BowCoordinate | WagasaCoordinate | CanonCoordinate | ClawCoordinate | StaffCoordinate
export type Path = KatanaPath | BowPath | WagasaPath | CanonPath  | ClawPath | StaffPath
