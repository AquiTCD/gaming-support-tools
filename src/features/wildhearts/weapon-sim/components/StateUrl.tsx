  ...
  return (
    <>
      <div className="flex text-xs md:text-sm mt-2">
        ...
        <input type="url" id="currentUrl" value={fullUrl} readOnly={true} className="text-left font-mono text-xs rounded-none rounded-r-lg bg-gray-50 border text-gray-900 block flex-1 min-w-0 w-full border-gray-300 px-1 py-0 md:px-3" />
