                        ...
                        <ul>
                          { [0,1,2].map(i => {
                            return currentWeapon?.inherentSkills[i] ?
                              <li key={i} className="bg-gray-900/75 h-6 pt-0.5 mb-1 px-2" data-tooltip-id="skill-tooltip" data-tooltip-content={currentWeapon.inherentSkills[i]}>{currentWeapon?.inherentSkills[i]}</li> :
                        ...
                        <ul>
                          { [...Array(5)].map((_, i) => i).map(i => {
                            ...
                            if (skill) {
                              ...
                              return <li key={i} className={classes} onClick={() => selectSkill(skill)} data-tooltip-id="skill-tooltip" data-tooltip-content={skill.name}>{skill.name}</li>
                            }
                        ...
                        <ul>
                          { [0,1,2].map(i => {
                            return selectedWeapon.inherentSkills[i] ?
                              <li key={i} className="bg-gray-900/75 h-6 pt-0.5 mb-1 px-2" data-tooltip-id="skill-tooltip" data-tooltip-content={selectedWeapon.inherentSkills[i]}>{selectedWeapon.inherentSkills[i]}</li> :
